  ...
  return (
    <div className="relative inline-block text-left" ref={dropdownRef} id="persona-switcher-container">
      ...
      <button
        ...
        className="group flex items-center gap-2.5 px-3.5 py-1.5 rounded-full bg-[#0d2a24] hover:bg-[#133931] border border-teal-500/30 hover:border-teal-400/50 shadow-sm transition-all duration-150 text-left focus:outline-none focus:ring-2 focus:ring-teal-400/40"
        title="Click to switch demo testing persona"
        aria-expanded={isOpen}
        aria-haspopup="true"
      >
        {/* Entity icon inside small badge */}
        <div className="flex-shrink-0 w-7 h-7 rounded-full bg-teal-500/20 text-teal-300 flex items-center justify-center border border-teal-500/40">
        ...
        <div className="flex flex-col text-left leading-tight pr-1 min-w-[130px] max-w-[210px]">
          <span className="text-[12.5px] font-semibold text-white truncate group-hover:text-teal-200 transition-colors">
            {displayName}
          </span>
        ...
        <ChevronDown
          className={`w-3.5 h-3.5 text-teal-300/80 transition-transform duration-200 ${
      ...
      {feedback && (
        <div className="absolute right-0 -bottom-8 px-2 py-0.5 rounded bg-teal-900/90 text-teal-200 text-[10px] font-medium shadow border border-teal-500/40 animate-fade-in whitespace-nowrap z-50">
          {feedback}
        </div>
      )}
      ...
      {isOpen && (
        <div
          ...
          className="absolute right-0 mt-2 w-80 rounded-xl bg-white shadow-2xl border border-slate-200/90 py-2.5 z-50 animate-in fade-in-50 zoom-in-95 duration-100 text-slate-800 ring-1 ring-black/10"
          role="menu"
        ...
        >
          ...
          <div className="px-3.5 pb-2 border-b border-slate-100">
            <div className="flex items-center justify-between">
              <span className="text-[10.5px] font-bold tracking-wider text-teal-700 uppercase">
              ...
              return (
                <button
                  ...
                  className={`w-full flex items-center justify-between px-3 py-2 rounded-lg text-left transition-all ${
                    isSelected
                      ? 'bg-teal-50/90 border border-teal-200/80 text-teal-950 font-medium'
                ...
                >
                  <div className="flex items-center gap-2.5 min-w-0">
                    ...
                    <div className="min-w-0">
                      <div className="text-[12px] font-semibold truncate text-slate-900 leading-snug">
                        {persona.name}
                      </div>
                  ...
                  {isSelected ? (
                    ...
                    <span className="text-[10px] text-slate-400 font-medium uppercase group-hover:text-slate-600">
                      Select
                    </span>
                  )}
                </button>
          ...
          <div className="mt-1 pt-2 px-3.5 border-t border-slate-100 flex items-center justify-between text-[10px] text-slate-400">
            <span>Dev / Demo Instant Persona Swapper</span>
            <span className="font-mono text-[9px] text-teal-600">v2025.1</span>
          </div>
        </div>
      )}
    </div>
