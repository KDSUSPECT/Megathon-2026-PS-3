...
export const SEEDED_PRODUCTION_RECORDS: ProductionRecord[] = [
  ...
  {
    id: 11,
    batchNumber: 'BATCH-2024-FACT-501',
    drugName: 'Dextromethorphan Cough Syrup 100ml',
    dosageForm: 'Oral Solution 100ml Bottle',
    unitDose: '10 mg/5ml',
    quantityProduced: 25000,
  ...
  {
    id: 12,
    batchNumber: 'BATCH-2024-HAZ-602',
    drugName: 'Diazepam 10mg/2ml Injectable',
  ...
  {
    id: 13,
    batchNumber: 'AML-05-2026E',
    drugName: 'Amlodipine 5mg Tablets',
    dosageForm: 'Oral Tablet',
    unitDose: '5 mg',
    quantityProduced: 45000,
  ...
  {
    id: 14,
    batchNumber: 'TEL-40-2026G',
    drugName: 'Telmisartan 40mg High-Yield',
    dosageForm: 'Oral Tablet',
    unitDose: '40 mg',
    quantityProduced: 35000,
  ...
  },
  {
    ...
    drugName: 'Insulin Glargine 100 IU/ml (Cold Chain)',
    dosageForm: 'Subcutaneous Solution Cartridge',
    unitDose: '100 IU/ml',
    quantityProduced: 15000,
...
export const SEEDED_BATCHES: Batch[] = [
  ...
  },
  {
    ...
    batchNumber: 'BATCH-2024-FACT-501',
    drugName: 'Dextromethorphan Cough Syrup 100ml',
    formulaName: 'Dextromethorphan HBr Oral Solution',
    manufacturingDate: '2024-04-10',
    expiryDate: '2026-04-10',
    currentStatus: 'RECEIVED_AT_MANUFACTURER',
    currentHolderRole: 'MANUFACTURER',
    currentHolderName: 'Sun Pharma Baddi Unit III',
    unitsCount: 450,
    unitPrice: 85.0,
    productionRecordId: 11,
  },
  {
    id: 12,
    batchNumber: 'BATCH-2024-HAZ-602',
    drugName: 'Diazepam 10mg/2ml Injectable',
    formulaName: 'Diazepam Injection BP',
    manufacturingDate: '2024-02-18',
    expiryDate: '2025-11-18',
  ...
  },
  {
    ...
    batchNumber: 'TEL-40-2026D',
    drugName: 'Telmisartan 40mg Tablets',
    formulaName: 'Telmisartan IP 40mg',
    manufacturingDate: '2025-05-15',
    expiryDate: '2026-10-25', // Expiring in ~45 days (< 60d)
    currentStatus: 'ACTIVE',
    currentHolderRole: 'RETAILER',
    currentHolderName: 'Apollo Medicos #402',
    unitsCount: 750,
    unitPrice: 58.0,
    productionRecordId: 10,
  },
  {
    id: 9,
    batchNumber: DEMO_KNOWN_DESTROYED_BATCH,
  ...
  },
  {
    ...
    batchNumber: 'AML-05-2026E',
    drugName: 'Amlodipine 5mg Tablets',
    formulaName: 'Amlodipine Besylate Oral Formulation',
    manufacturingDate: '2024-03-01',
    expiryDate: '2026-03-01',
    currentStatus: 'SCHEDULED_FOR_DESTRUCTION',
    currentHolderRole: 'WASTE_FACILITY',
    ...
    unitsCount: 1200,
    unitPrice: 42.0,
    productionRecordId: 13,
  },
  {
    id: 14,
    batchNumber: 'TEL-40-2026G',
    drugName: 'Telmisartan 40mg High-Yield',
    formulaName: 'Telmisartan IP 40mg Formulation',
    manufacturingDate: '2024-01-15',
    expiryDate: '2025-12-15',
    currentStatus: 'SCHEDULED_FOR_DESTRUCTION',
    currentHolderRole: 'WASTE_FACILITY',
...
export const SEEDED_PICKUP_CONFIRMATIONS: PickupConfirmation[] = [
  {
    ...
    distributorLicense: 'DL-2023-DIS-33014',
    ...
    agentNotes: 'Cold-chain expired insulin cartridges. 850 received; 150 units damaged in transit prior to receipt.',
    signingPinUsed: '4421',
    certificateReference: 'CDSCO-REV-DIST-2026-00305',
    certificateHash: 'c4d5e6f7a8b9c0d1e2f3a4b5c6d7e8f9a0b1c2d3e4f5a6b7c8d9e0f1a2b3c4d5',
    sealAuthorized: true,
  ...
  },
  {
    ...
    agentNotes: 'Verified 800 intact expired Ceftriaxone sterile vials. Foil packaging and outer cartons intact.',
    signingPinUsed: '4421',
    certificateReference: 'CDSCO-REV-DIST-2026-00406',
  ...
  },
  {
    ...
    agentNotes: 'Bulk Azithromycin 500mg tablets expired. Sealed inside tamper-evident poly-crates.',
    signingPinUsed: '4421',
    certificateReference: 'CDSCO-REV-DIST-2026-00881',
    certificateHash: 'e2f3a4b5c6d7e8f9a0b1c2d3e4f5a6b7c8d9e0f1a2b3c4d5e6f7a8b9c0d1e2f3',
    sealAuthorized: true,
  ...
  },
  {
    ...
    agentNotes: 'Expired Ciprofloxacin 500mg infusion bottles. Transferred under Schedule M security protocol.',
    signingPinUsed: '4421',
    certificateReference: 'CDSCO-REV-DIST-2026-09981',
